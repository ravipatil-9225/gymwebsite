...
import { User, Mail, Phone, Calendar, MessageSquare, ArrowRight, CheckCircle, Users } from 'lucide-react';
import axios from 'axios';

const BookGroupClass = () => {
            ...
            >
                {status === 'success' ? (
                    <div className="text-center py-8">
                        ...
                        <h2 className="text-3xl font-display font-bold text-white mb-4 tracking-wider">BOOKING RECEIVED</h2>
                        <p className="text-gray-300 text-lg mb-8 max-w-md mx-auto">
                            Your spot has been tentatively reserved! Check your email for confirmation details.
                        </p>
                        <button
                    ...
                    <>
                        <div className="text-center mb-10">
                            <h2 className="text-primary tracking-[0.2em] font-sans font-semibold text-xs mb-2 uppercase">Sweat Together</h2>
                            <h1 className="text-white text-4xl font-display font-bold uppercase tracking-wider">Book Group Class</h1>
                        </div>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <div className="relative">
                                ...
                                <textarea
                                    name="message" disabled={status === 'submitting'}
                                    ...
                                    placeholder="Any injuries or notes?"
