            ...
            >
                {status === 'success' ? (
                    <div className="text-center py-8">
                        ...
                        <h2 className="text-3xl font-display font-bold text-white mb-4 tracking-wider">ENQUIRY SENT</h2>
                    ...
                    <>
                        <div className="text-center mb-10">
                            <h2 className="text-primary tracking-[0.2em] font-sans font-semibold text-xs mb-2 uppercase">Got Questions?</h2>
                            <h1 className="text-white text-4xl font-display font-bold uppercase tracking-wider">General Enquiry</h1>
                        </div>
